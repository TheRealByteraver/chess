...
//       // Typical middlegame with tension in the center.
//   'r2q1rk1/ppp2ppp/2n2n2/3b4/3P4/2NB1N2/PPPQ1PPP/R3R1K1 b - - 0 15',
...
const LASTMOVESTART = 2;
const LASTMOVEEND = 3;
const LASTMOVEMASK = 3;
const SELECTEDPIECE = 4;
const POSSIBLEMOVE = 8;
